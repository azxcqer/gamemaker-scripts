...
///drawTextShadow(x, y, text, textcolor, shadowcolor, shadowdist, reset boolean)
...
drawTextShadow(textX, textY, text, c_white, c_black, 1, false)
...
drawTextShadow(textX, textY, text, color, c_black, 1, false)

#define drawTextReset
///drawTextReset()
